...
section_label: About
description: A USDA partnership modernizing the data behind FSA livestock disaster assistance — so programs deliver effective, targeted relief to American producers.
---
...
This is a three-year research partnership between the [Montana Climate Office](https://climate.umt.edu) at the University of Montana and the USDA Office of the Chief Economist, the USDA Climate Hubs, and the Farm Service Agency. The work has produced four complementary outputs, all openly available on this site:

- **Re-grounded the science.** Using the methodology FSA set out in **Notice NAP-190** and the latest **NOAA nClimGrid** daily climate data, the team rebuilt the county-level Normal Grazing Period calculation as a fully reproducible workflow anchored to the current (1991–2020) climate normals. The same pipeline can be re-run on each new climate normal — so program criteria can stay current with measured conditions rather than going stale. The full report is published on the [Publications page](/publications/).
...
In the course of this work the team identified a notable program-administration finding: LFP eligibility has been determined using a non-authoritative county boundary dataset — one maintained outside USDA that was adopted before the 2008 Farm Bill and has been revised only three times since, even as the US Census has recorded 472 county boundary corrections and changes from 2008 through 2025 alone. The finding was presented to USDA OCE-OEEP; a fuller report is in preparation.
